...
def create_station(stations_created)
...
def create_train(trains_created)
...
def create_or_change_route(routes_created, stations_created)
  ...
  when 1
    ...
    if stations_created.length < 2
      ...
      show_stations(stations_created)
  ...
  when 2
    ...
    when 1
        ...
        temp = create_station(stations_created)
...
def push_remove_wagon(trains_created)
  show_trains(trains_created)
...
def show_stations_and_trains(stations_created, trains_created)
  puts '==========================='
...
while true
  ...
  when 1
    ...
    puts '==========================='
    create_station(stations_created)
    puts '==========================='

  when 2

    puts '==========================='
    create_train(trains_created)

  when 3

    puts '==========================='
    create_or_change_route(routes_created, stations_created)
    
  when 4

    set_route(trains_created, routes_created)

  when 5

    push_remove_wagon(trains_created)

  when 6

    move_train(trains_created)

  when 7

    show_stations_and_trains(stations_created, trains_created)
    puts '==========================='
